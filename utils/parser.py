...
def get_base_parser():
    ...
    parser.add_argument('--data_path', default=os.path.join(os.path.dirname(os.path.abspath(__file__)).split('SimTrans-Weak-Shot-Classification')[0]+'SimTrans-Weak-Shot-Classification', "workspace/dataset/CUB"), type=str)
