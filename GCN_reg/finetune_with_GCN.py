...
def add_pretrain(parser):
    ...
    parser.add_argument('--load_dir', type=str, default='pretrained/similarity/CUB/clean_base')
    ...
    parser.add_argument('--resume', type=str,
                        default='pretrained/main_avg1000_Wclean_base_CUB_lr0.0001_b8_100_0.1_05200233_89.5.pth')
...
def main():
    ...
    args.exp_name += f'Finetune_{args.reg}_EF{args.epoch_fraction}_a{args.alpha}_{args.weight_type}' \
