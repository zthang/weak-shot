...
def add_pretrain(parser):
    ...
    parser.add_argument('--similarity_net', type=str, default="saves/GANSimilarity__tnovel_train_beta0.0_clean_base2noisy_novel_CUB_lr0.005_b50_h4_bnA20_bnB2_sw0_nf0_10281646/simnet_GANSimilarity__tnovel_train_beta0.0_clean_base2noisy_novel_CUB_lr0.005_b50_h4_bnA20_bnB2_sw0_nf0_10281646_best.pth")
    parser.add_argument('--load_dir', type=str, default='saves/h4f0_84.5')
    parser.add_argument('--resume', type=str, default='saves/main_EF1_one_mean_savg1_Wh4f0_84.5_CUB_lr0.0001_b8_20_0.5_10291125/main_EF1_one_mean_savg1_Wh4f0_84.5_CUB_lr0.0001_b8_20_0.5_10291125_best.pth')
