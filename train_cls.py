...
def main():
    ...
    retrieve_dict = get_retrieve_dict()
    ...
    for epoch in range(args.num_epoch):
        ...
        test_meter = evaluation(args, epoch, model, test_loader, retrieve_dict)
...
def evaluation(args, epoch, model, data_loader, retrieve_dict):
